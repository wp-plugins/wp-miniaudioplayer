        ...
        <form id="optionsForm" method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input type="checkbox" name="miniAudioPlayer_download"
            ...
            <input type="hidden" name="page_options"
                   value="miniAudioPlayer_donate, miniAudioPlayer_width, miniAudioPlayer_skin, miniAudioPlayer_volume, miniAudioPlayer_showVolumeLevel, miniAudioPlayer_showTime, miniAudioPlayer_showRew, miniAudioPlayer_excluded, miniAudioPlayer_download"/>
